# Lo que MAGI cree de MAGI

Generado por `magi.modules.swarm.automodelo`. Cada afirmación
lleva la prueba que puede tumbarla. Sin prueba no se admite.

## Refutadas por la realidad

- [REFUTADA] El nucleo SH2DynARM arranca el juego  (0/1)
      la realidad dijo: cuelga al primer frame en tres builds independientes (-Ofast, -O3 y el VPK del CI); la cache JIT se aloja bien en 0x82800000
- [REFUTADA] Se detectar si una pulsacion cruza al juego  (0/1)
...
- [OK] Se compilar el VPK de YabauseVita en CI  (1/1)
- [OK] Se medir el rendimiento del emulador con corrida verificada  (1/1)
- [REFUTADA] El nucleo SH2DynARM arranca el juego  (0/1)
      la realidad dijo: cuelga al primer frame en tres builds independientes (-Ofast, -O3 y el VPK del CI); la cache JIT se aloja bien en 0x82800000
- [REFUTADA] Se detectar si una pulsacion cruza al juego  (0/1)
      la realidad dijo: el attract ya se mueve solo: el delta de medianas no aisla la pulsacion. Redisenado con pico de transicion y control, pero sin confirmar en pantalla que responda
