...
from .schema import ConfigDeclarationRegister, ConfigField
...
class ConfigFusionEngine:
    ...
    def __init__(self, register: ConfigDeclarationRegister):
        ...
        self.traceability: Dict[str, Tuple[Any, str, Optional[str]]] = {}
    ...
    def get_traceability(self, path: str) -> Tuple[Any, str, Optional[str]]:
